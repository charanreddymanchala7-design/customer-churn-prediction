# Telco Classification Project - Maintained by Charan Reddy Manchala
...
- The top 4 drivers of churn are:
...
- The meachine learning model: logistic regression classifier is expected to predict churn with **81% accuracy** on future unseen data
...
## Next Steps
- Collect more data on customers' **demographic information** (eg. place of residence, socio-economic data such as occupation, household income.)

- Develop machine learning models with higher accuracy with these additonal data and more accurate features.

- Conduct **price discrimination analysis** to further determine the price point for each contract type and service.

## About the Maintainer

This project is currently maintained by Charan Reddy Manchala.

Charan is a 5x Certified Salesforce Developer with 8 years of experience designing, developing, and implementing innovative solutions on the Salesforce platform. He specializes in integrating Salesforce with external systems using various APIs and patterns, and optimizing applications for performance and scalability.

**Key Skills:** Apex, SOQL, SOSL, LWC, Visualforce, Aura Components

**Contact:**
- Email: charanreddymanchala9@gmail.com
- GitHub: Charan Reddy Manchala
